...
export default function Hero({}: {}) {
  return (
    <Container className='my-40 flex flex-col gap-4 justify-center items-center'>
      ...
      <p className='max-w-2xl text-xl text-center'>
        I'm a frontend developer with a passion for building interactive web
        applications using React, Next.js, and the Canvas API. I care deeply
